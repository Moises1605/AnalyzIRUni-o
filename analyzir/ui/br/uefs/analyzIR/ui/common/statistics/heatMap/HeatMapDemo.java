package br.uefs.analyzIR.ui.common.statistics.heatMap;
...
public class HeatMapDemo extends JFrame implements ItemListener, FocusListener {
    ...
    public HeatMapDemo(double[][] dados, String[] values) throws Exception {
        super("Heat Map");
        this.dados = dados;
        this.values = values;
        ...
        listPane.setBorder(BorderFactory.createTitledBorder("Heat Map"));
        ...
        panel = new HeatMap(dados, values, HeatMap.GRADIENT_BLACK_TO_WHITE);
        gradientComboBox.setSelectedIndex(0);

        // set miscelaneous settings
        panel.setDrawLegend(true);

        panel.setTitle("Correlation Test");
        textTitle.setText("Correlation Test");
        panel.setDrawTitle(true);

        panel.setXAxisTitle("Systems");
        textXTitle.setText("Systems");
        panel.setDrawXAxisTitle(true);

        panel.setYAxisTitle("Systems");
        textYTitle.setText("Systems");
    ...
    private static void createAndShowGUI(double[][] dados, String[] values) throws Exception {
        HeatMapDemo hmd = new HeatMapDemo(dados,values);
        hmd.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        hmd.setSize(800, 600);
        hmd.setVisible(true);
