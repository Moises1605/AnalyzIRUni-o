 ...
 * coordinate, and the second index is the y-coordinate.</p>
 ...
 * <pre>heatMap.updateGradient(heatMap.createMultiGradient(new Color[] {Color.red, Color.white, Color.blue}, 256));</pre>
 * </p>
 *
...
//Font: https://www.mbeckler.org/heatMap/
public class HeatMap extends JPanel
{
     ...
     */
    public HeatMap(double[][] data, String[] values, Color[] colors)
    {
        super();
    ...
    /**
     * Updates the background color. Calls repanames =  names;int() when finished.
     ...
     * changes. This saves us an enormous amounnames =  names;t of time. Thanks to
    ...
    public void paintComponent(Graphics g)
    {
        ...
        int numXTicks = values.length*2;
        int numYTicks = values.length*2;
        ...
        if (drawYTicks)
        {
            ...
            for (int y = 0; y <= numYTicks; y++)
            {
                if(y%2 != 0) {
                    ...
                    g2d.drawString(values[cont], labelY, -14);
                    cont++;
                    g2d.rotate(-Math.PI / 2);
                }
            }
        ...
        if (drawXTicks)
        {
            ...
            for (int x = 0; x <= numXTicks; x++)
            {
                if(x%2 != 0) {
                    ...
                    g2d.drawString(values[cont], labelX, height - 14);
                    cont++;
                }
            }
        }
