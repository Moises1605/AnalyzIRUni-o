...
public class ConfigPlotFRel {
    ...
    public ConfigPlotFRel(Facade facade) {
    ...
    private void loadInfo() {
        ...
        java.util.List<String> runs = facade.listRuns();
        java.util.List<String> topics = facade.listTopics();
    ...
    private void initLayout() {
        ...
        builder.add(btnSingleBackT, CC.xy(4, 15));
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (rows.length > 0) {
                    ...
                    for (int i = begin; i >= 0; i--) {
                        ...
                        if(selectedTopics.getRowCount() >0){
                            selectedTopics.remove(0, 1);
                            System.out.println(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>");
                        }
    ...
    public void showFrel() {
        ...
        btnGenerate.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                java.util.List<String> runs = new ArrayList<String>();
                ...
                ArrayList frelList = new ArrayList();
                Integer atValue = Integer.parseInt(txtAtVAlue.getText());
                try {
                    for (int i = 0; i < runs.size(); i++) {
                        frelList.add((failure.calculatefrel(runs.get(i), topics.get(0), atValue)));
                    }
                ...
                FRelStackedBarChart staked = new FRelStackedBarChart("F_REL GRAPH", frelList, runs);

                staked.show(frelList, runs);
            }
        });
    }
